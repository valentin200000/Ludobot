...
Page {
    ...
    Component.onCompleted: {
        console.log("DEBUG - SVTQuizPage.qml - Component.onCompleted")
        loadQuestions()
    }
    
    // Charger les questions depuis le CSV
    function loadQuestions() {
        console.log("DEBUG - Début du chargement des questions de SVT")
            ...
            if (result) {
                ...
                questions = [
                    ...
                    },
                    {
                        ...
                        answers: ["Le foie", "Le cœur", "Les poumons", "L'estomac"],
                        correct: "Le cœur"
                    },
                    {
