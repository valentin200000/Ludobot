...
Page {
    id: contactPage
    title: qsTr("Contacts du résident")
    // appMode peut être passé par le parent; valeur par défaut sécurisée: "enfant"
    ...
    Component.onCompleted: {
        console.log("Démarrage de la page Contact Résident")
        // Charger les contacts depuis le fichier CSV via le ContactLoader
        var contacts = residentContactLoader.loadContacts()
    ...
    function chargerContactsManuellement() {
        ...
        // Contacts famille
        contactModel.append({"service": "Famille", "profession": "Fils", "nom": "Jean Dupont", "telephone": "01 23 45 67 89"});
        contactModel.append({"service": "Famille", "profession": "Fille", "nom": "Marie Dupont", "telephone": "01 23 45 67 90"});
        contactModel.append({"service": "Famille", "profession": "Petit-fils", "nom": "Paul Dupont", "telephone": "01 23 45 67 91"});
    ...
    Dialog {
        ...
        function openCSVEditor() {
            ...
            residentContactLoader.openCSVEditor()
        }
        ...
        contentItem: Column {
            ...
            Text {
                width: parent.width
                horizontalAlignment: Text.AlignHCenter
                text: "Édition du fichier resident_contacts.csv"
                font.pixelSize: 22
                font.bold: true
                wrapMode: Text.WordWrap
            }
            ...
            Text {
                width: parent.width
                text: "Le fichier resident_contacts.csv contient tous les contacts du résident. Vous pouvez l'éditer directement pour ajouter, modifier ou supprimer des contacts."
                font.pixelSize: 18
                wrapMode: Text.WordWrap
            }
            ...
            Text {
                width: parent.width
                text: "Exemple:\nFamille,Fils,Jean Dupont,01 23 45 67 89"
                font.pixelSize: 18
                wrapMode: Text.WordWrap
                color: "#F57C00" // Orange accentColor
            }
            ...
            Button {
                ...
                onClicked: {
                    ...
                    residentContactLoader.loadContacts()
