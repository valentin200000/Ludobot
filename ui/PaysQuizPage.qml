...
Page {
    ...
    Component.onCompleted: {
        console.log("DEBUG - PaysQuizPage.qml - Component.onCompleted")
        loadQuestions()
    }
    
    // Charger les questions depuis le CSV
    function loadQuestions() {
        console.log("DEBUG - Début du chargement des questions de pays")
        ...
        try {
            ...
            try {
                ...
                if (typeof subjectLoader !== "undefined" && subjectLoader !== null) {
                    ...
                    result = subjectLoader.loadQuestions("pays", selectedAge)
            ...
            if (!result && typeof quizController !== "undefined" && quizController !== null) {
                ...
                result = quizController.loadQuestions("pays", selectedAge)
                ...
                questions = [
                    {
                        ...
                        answers: ["Angleterre", "France", "Italie", "Espagne"],
                        correct: "France"
                    },
                    {
                        question: "Quel pays a la forme d'une botte ?",
                        answers: ["Grèce", "Portugal", "Italie", "Croatie"],
                        correct: "Italie"
                    },
                    {
    ...
    function showResults() {
        ...
        if (percentage >= 80) {
            resultMessage.text = "Excellent ! Tu connais bien les pays du monde !"
