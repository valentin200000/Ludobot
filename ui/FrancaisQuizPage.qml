...
Page {
    ...
    Component.onCompleted: {
        console.log("DEBUG - FrancaisQuizPage.qml - Component.onCompleted")
        loadQuestions()
    }
    
    // Charger les questions depuis le CSV
    function loadQuestions() {
        console.log("DEBUG - Début du chargement des questions de français")
        ...
        try {
            ...
            try {
                ...
                if (typeof subjectLoader !== "undefined" && subjectLoader !== null) {
                    ...
                    result = subjectLoader.loadQuestions("francais", selectedAge)
            ...
            if (!result && typeof quizController !== "undefined" && quizController !== null) {
                ...
                result = quizController.loadQuestions("francais", selectedAge)
                ...
                questions = [
                    {
                        ...
                        answers: ["Actrice", "Acteure", "Acteuse", "Actrice"],
                        correct: "Actrice"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        answers: ["Triste", "Fâché", "Heureux", "Fatigué"],
                        correct: "Heureux"
                    }
                ]
    ...
    function showResults() {
        ...
        if (percentage >= 80) {
            resultMessage.text = "Excellent ! Tu es très fort en français !"
