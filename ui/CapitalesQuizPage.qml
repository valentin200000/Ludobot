...
Page {
    ...
    Component.onCompleted: {
        console.log("DEBUG - CapitalesQuizPage.qml - Component.onCompleted")
        loadQuestions()
    }
    
    // Charger les questions depuis le CSV
    function loadQuestions() {
        console.log("DEBUG - Début du chargement des questions de capitales")
        ...
        try {
            ...
            try {
                ...
                if (typeof subjectLoader !== "undefined" && subjectLoader !== null) {
                    ...
                    result = subjectLoader.loadQuestions("capitales", selectedAge)
            ...
            if (!result && typeof quizController !== "undefined" && quizController !== null) {
                ...
                result = quizController.loadQuestions("capitales", selectedAge)
                ...
                questions = [
                    {
                        ...
                        answers: ["Madrid", "Barcelone", "Séville", "Valence"],
                        correct: "Madrid"
                    },
                    {
                        question: "Quelle est la capitale de l'Italie ?",
                        answers: ["Milan", "Naples", "Rome", "Florence"],
                        correct: "Rome"
                    },
                    {
    ...
    function showResults() {
        ...
        if (percentage >= 80) {
            resultMessage.text = "Excellent ! Tu connais bien les capitales !"
