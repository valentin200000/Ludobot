...
class ContactLoader(QObject):
    """Classe pour charger les contacts depuis un fichier CSV"""
    ...
    def __init__(self, parent=None):
        ...
        print("ContactLoader initialisé")
    ...
    def loadContacts(self):
        ...
        try:
            ...
            csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "quizzes", "contacts.csv")
            print(f"Chargement des contacts depuis {csv_path}")
            ...
            with open(csv_path, encoding="utf-8") as csvfile:
                ...
                for row in reader:
                    if len(row) >= 4:
                        ...
                        print(f"Contact ajouté: {row[0]}, {row[1]}, {row[2]}, {row[3]}")
            
            print(f"Nombre total de contacts chargés: {len(contacts)}")
